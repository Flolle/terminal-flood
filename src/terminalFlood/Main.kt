...
fun printHelp() {
    ...
    println("  -colors N    \t --")
    println("\t\tThe amount of colors used for the game. Only values between 2 and ${Character.MAX_RADIX - 1} (excluding) are")
    ...
    println("  [startPos]   \t --")
    println("\t\tThe start position of the game boards. The option is exactly the same as the argument")
    ...
    println("4 threads, the astar_iaf strategy and using the upper left corner as the start position for the")
